...
import { faApple, faFacebook, faGoogle, faInstagram, faYoutube } from '@fortawesome/free-brands-svg-icons';
import {   faHome, faContactBook, faCalendar } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-8 relative right-7 md:mb-0">
              ...
              <p className=' text-2xl mt-6 text-black'>Generate outside the box <br />
                thinking with the possiblity to  <br />
                target the low.
              </p>
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
              <div>
                <h2 className="mb-8 text-lg font-semibold text uppercase text-black">
                  Products
                </h2>
                <ul className="text-gray-500 dark:text-white font-medium">
                  <li className="mb-8">
                    <a href="/" className="hover:opacity-75 flex items-center text-black">
              ...
              <div>
                <h2 className="mb-8 text-lg font-semibold text-black uppercase">
                  Resources
                </h2>
                <ul className="text-gray-500 dark:text-white font-medium">
                  <li className="mb-8">
              ...
              {/* New Column for Partner Community */}
              <div>
                <h2 className="mb-8 text-lg font-semibold text-black uppercase">
                  Company
                </h2>
          ...
          <div className="sm:flex sm:items-center sm:justify-center">
            <span className="text-sm text-black sm:text-center dark:text-black">
              © 2024. All Rights Reserved to Yogesh GC.
            </span>
          </div>
        </div>
      </footer>
